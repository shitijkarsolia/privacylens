...
const steps = [
  {
    ...
    detail: "Run npm run build. Chrome loads the generated dist folder.",
  ...
  },
  {
    icon: FolderOpen,
    title: "Load unpacked",
    detail: "Choose the dist folder generated by the build.",
    command: "./dist",
  },
  {
    icon: Chrome,
    ...
    <main className="min-h-screen bg-[#FDFCFB] text-[#111827]">
      <section className="mx-auto grid min-h-screen max-w-[1180px] grid-cols-[0.95fr_1.05fr] gap-14 px-8 py-10 max-lg:grid-cols-1 max-sm:px-4">
        <div className="flex flex-col justify-between">
          <div>
            <a href="/" className="inline-flex items-center gap-2 text-sm font-semibold text-[#079B8E]">
              <ArrowLeft size={18} />
              Back to PrivacyLens
            </a>
