    ...
    >
      <div className="max-w-3xl mx-auto px-4 py-3">
        ...
        {fileScanning && fileName && (
          <div className="mb-2 flex items-center gap-2 text-xs font-mono px-3 py-2 rounded-lg bg-[var(--color-accent)]/5 border border-[var(--color-accent)]/15 text-[var(--color-accent)]">
            <div className="w-3 h-3 border-2 border-current border-t-transparent rounded-full animate-spin" />
            Scanning {fileName} for personal data...
          </div>
        )}
